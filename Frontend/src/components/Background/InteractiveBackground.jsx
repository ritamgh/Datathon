    ...
    class Tile {
      ...
      update() {
        ...
        if (distance < interactDistance) {
          ...
          this.color.r = Math.floor(
            this.originalColor.r + (40 - this.originalColor.r) * intensity
          );
          this.color.g = Math.floor(
            this.originalColor.g + (100 - this.originalColor.g) * intensity
          );
          this.color.b = Math.floor(
            this.originalColor.b + (255 - this.originalColor.b) * intensity
          );
